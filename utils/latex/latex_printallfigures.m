...
% latex_printallfigures prints a figure that is ready to be used as an EPS for Latex
%
...
elseif strcmp(mode, 'paper_wide_half')
    ...
    h = 4;
    f = 24;
elseif strcmp(mode, 'paper_wide')
    w = 16;
    h = 8;
    f = 34;
elseif strcmp(mode, 'paper_wide_half_toplegend')
    w = 8;
    h = 6;
    f = 24;
