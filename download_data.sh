...
# 1. Go to https://surfdrive.surf.nl/files/index.php/s/xrkOTVP30KI5Hle/
# 2. Click on download and download the zip file (it's almost 15GB!)
# 3. Unpack the file and rename the main folder to data_paper

wget  https://surfdrive.surf.nl/files/index.php/s/SATKxMKwwQX26Jp/download

unzip download

mv AURO_BLE_relative_localization_data/ data
